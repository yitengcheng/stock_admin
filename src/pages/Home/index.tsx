...
import { Layout, Menu, Avatar, Button, Space, Spin, Image, Badge, Divider, Breadcrumb, notification } from "antd";
      ...
      <Layout style={{ height: "100vh" }}>
        <Header className={styles.site_layout_header} style={{ backgroundColor: "#fff" }}>
          ...
          <div className={styles.headerRight_box}>
            ...
            <div style={{ height: "30%", width: "1px", backgroundColor: "#CFCFCF" }}></div>
